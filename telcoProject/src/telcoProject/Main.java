...
public class Main {
    public static void main(String[] args){
        ...
        CorporateCustomer corporateCustomer1 = new CorporateCustomer(1,"12345278278",subscriptions,addresses,"55656556566","Kahraman LTD.ÞTÝ");
        
        Address address1 = new Address(1,"Ýzmir",addressType1,corporateCustomer1);
        
        Service service1 = new Service(1,"Telefon",products);
        
        AdslProduct adslProduct1 = new AdslProduct(1,"ASUS","13456","Bakýr","1",service1,5,2);
        ...
        Channel channel1 = new Channel(1,"Ýnternet Bankacýlýðý",payments);
        IndividualCustomer individualCustomer1 = new IndividualCustomer(2,"789456",subscriptions,addresses,"Yasin","Kahraman","52525252552552");
